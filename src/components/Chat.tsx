...
export const Chat = ({user}:{user:User}) => {
    ...
    const handleSend = async (text:string) => {
        ...
        const response = await fetch("https://www.lightonmatter.it/wp-json/wp/v2/comments?author_name="+user.id+"&author_email=mir.conti@protonmail.com&content="+text+"&post="+activeConversation?.id, requestOptions);
